...
void tache1(void)
{
    ...
    unsigned char ma_tache = 1;
    unsigned char n;
    unsigned char buffer_vitesse_plus = 1;
    unsigned char buffer_vitesse_moins = 1;
    unsigned char buffer_batterie_plus = 1;
    unsigned char buffer_batterie_moins = 1;
    (INTCONbits.GIE = 0);
