...
void tache5(void)
{
    unsigned int buffer_tick = 0;
    unsigned int length_tick = 100;

    unsigned char sample_vitesse[20];
    unsigned char sample_count = 10;
               ...
               if(cptT5 == sample_count)
                {
                    ...
                    buffer_batterie = buffer_batterie / 100;
                    batterie = (char)buffer_batterie;
