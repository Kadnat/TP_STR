...
{  
    ...
    task_control[2].priority = 6;  task_control[2].period = 50;  task_control[2].next_tick = 0; task_control[2].is_ready = 1;
    task_control[3].priority = 5;  task_control[3].period = 15; task_control[3].next_tick = 0; task_control[3].is_ready = 1;
