...
void tache4(void)
{
    ...
    for(unsigned char i = 9 ; i >= 3 ; i--)
    {
        /*goto_lico(i, 1); draw_char('*');goto_lico(i, 13); draw_char('*');
        goto_lico(i, 14); draw_char('*');goto_lico(i, 25); draw_char('*');
        goto_lico(i, 27); draw_char('*');goto_lico(i, 38); draw_char('*');*/
        goto_lico(i, 13); draw_char('*');goto_lico(i, 26); draw_char('*');
    }
    ...
    goto_lico(0,9); draw_char('S'); draw_char('I'); draw_char('M'); draw_char('U'); draw_char('L'); draw_char('A'); draw_char('T'); draw_char('O'); draw_char('R');
        ...
        //titres:
    goto_lico(11, 2); draw_char('T'); draw_char('e'); draw_char('m');draw_char('p');
    goto_lico(11, 7); draw_char('E'); draw_char('a'); draw_char('u');
    
    goto_lico(11, 28); draw_char('T');  draw_char('e');  draw_char('m');  draw_char('p');
    goto_lico(11, 33); draw_char('H');  draw_char('u');  draw_char('i');  draw_char('l'); draw_char('e');
    
    goto_lico(11, 16); draw_char('V'); draw_char('i'); draw_char('t');
    goto_lico(11, 19); draw_char('e'); draw_char('s'); draw_char('s'); draw_char('e'); 
    
    //unités
    goto_lico(14, 19);draw_char('k');draw_char('m'); draw_char('/'); draw_char('h');
